...
import { CiMenuBurger, CiSearch, CiChat1, CiShoppingCart } from "react-icons/ci"

const getTotalCount = (cart: Record<string, number>): number => {
  return Object
    .values(cart)
    ...
    <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
      ...
      <div className="px-6 flex items-center justify-between space-x-4">
        ...
        <div className="flex space-x-2">
          ...
          <Link href={'/dashboard/cart'} className="flex items-center justify-center gap-2 px-2 h-10 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
            {(totalItems > 0) && (<span className="font-bold text-blue-800">{totalItems}</span>)}
